...
- Run `pnpm format:check`, `pnpm lint`, `pnpm repo:hygiene:check`, `pnpm license:scan`, `pnpm protocol:manifest:check`, `pnpm protocol:drift:check`, `pnpm docs:check`, `pnpm typecheck`, `pnpm test`, `pnpm build`, `pnpm security:scan`, and `pnpm release:state` before requesting review.
